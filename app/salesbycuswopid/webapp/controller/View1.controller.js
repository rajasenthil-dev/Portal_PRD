sap.ui.define([
    ...
    return Controller.extend("salesbycuswopid.controller.View1", {
        onInit: async function () { 
            ...
            var oCurrentStatus = new sap.m.ObjectStatus({
                text: oBundle.getText("SALESBYCURRENTWOPID.CURRENTTEXT"),
                icon: "sap-icon://circle-task-2",
                state: "Success",
                inverted:true,
                tooltip:oBundle.getText("SALESBYCURRENTWOPID.CURRENTTOOLTIP"),
            })
            ...
            var oLegacyStatus = new sap.m.ObjectStatus({
                text: oBundle.getText("SALESBYCURRENTWOPID.LEGACYTEXT"),
                icon: "sap-icon://circle-task-2",
                state: "Information",
                inverted:true,
                tooltip:oBundle.getText("SALESBYCURRENTWOPID.LEGACYTOOLTIP"),
            })
